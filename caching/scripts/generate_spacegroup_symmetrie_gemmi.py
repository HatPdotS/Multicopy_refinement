...
def get_gemmi_symmetry_operations(sg_name):
    ...
    rot, tran = zip(*gemmi_ops)
    rot_tensor = torch.stack(rot)
    tran_tensor = torch.stack(tran)
    return rot_tensor, tran_tensor
...
spacegroups_all = [
    ...
    # Monoclinic (3-15)
    'P2', 'P21', 'C2', 'Pm', 'Pc', 'Cm', 'Cc', 'P2/m', 'P21/m', 'C2/m',
    'P2/c', 'P21/c', 'C2/c',
    
    # Orthorhombic (16-74)
    'P222', 'P2221', 'P21212','P22121', 'P212121', 'C2221', 'C222', 'F222', 'I222',
    'I212121', 'Pmm2', 'Pmc21', 'Pcc2', 'Pma2', 'Pca21', 'Pnc2', 'Pmn21',
    'Pba2', 'Pna21', 'Pnn2', 'Cmm2', 'Cmc21', 'Ccc2', 'Amm2', 'Aem2',
    'Ama2', 'Aea2', 'Fmm2', 'Fdd2', 'Imm2', 'Iba2', 'Ima2',
    ...
    'I422', 'I4122', 'P4mm', 'P4bm', 'P42cm', 'P42nm', 'P4cc', 'P4nc',
    ...
    # Hexagonal (168-194)
    'P6', 'P61', 'P65', 'P62', 'P64', 'P63', 'P-6',
    'P6/m', 'P63/m', 'P622', 'P6122', 'P6522', 'P6222', 'P6422', 'P6322',
    'P6mm', 'P6cc', 'P63cm', 'P63mc', 'P-6m2', 'P-6c2', 'P-62m', 'P-62c',
    'P6/mmm', 'P6/mcc', 'P63/mcm', 'P63/mmc','H3','H32',
    
    # Cubic (195-230)
    'P23', 'F23', 'I23', 'P213', 'I213', 'Pm-3', 'Pn-3', 'Fm-3', 'Fd-3',
    ...
    'Fd-3c', 'Im-3m', 'Ia-3d','I121','P2212','P21221'
]
...
if __name__ == "__main__":
    ...
    path_this_dir = os.path.dirname(os.path.dirname(path_this_file))
    path_data_dir = os.path.join(path_this_dir, 'files')
    os.makedirs(path_data_dir, exist_ok=True)

    torch.save(ops, os.path.join(path_data_dir, 'gemmi_symmetry_operations.pt'))